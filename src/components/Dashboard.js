  ...
  return (
    <div className={`p-6 min-h-screen pt-20 pb-20 ${darkMode ? 'bg-gray-900 text-white' : 'bg-gray-100 text-gray-900'}`}>
      ...
      <section className="mb-8">
        <h1 className="text-3xl sm:text-4xl font-bold mb-4 text-center" data-testid="dashboardTitle">Portfolio Dashboard</h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
          <div className="bg-white p-4 rounded-lg shadow-lg transform cursor-pointer hover:scale-105 transition duration-300 text-center" onClick={() => handleNavigation('project')}>
            ...
            <h3 className="text-lg sm:text-xl font-bold">Explore Projects</h3>
          ...
          <div className="bg-white p-4 rounded-lg shadow-lg transform cursor-pointer hover:scale-105 transition duration-300 text-center" onClick={() => handleNavigation('analytics')}>
            ...
            <h3 className="text-lg sm:text-xl font-bold">View Analytics</h3>
          ...
          <div className="bg-white p-4 rounded-lg shadow-lg transform cursor-pointer hover:scale-105 transition duration-300 text-center" onClick={() => handleNavigation('taskmanager')}>
            ...
            <h3 className="text-lg sm:text-xl font-bold">Manage Tasks</h3>
          ...
          <div className="bg-white p-4 rounded-lg shadow-lg transform cursor-pointer hover:scale-105 transition duration-300 text-center" onClick={() => handleNavigation('recentactivities')}>
            ...
            <h3 className="text-lg sm:text-xl font-bold">Recent Activities</h3>
      ...
      <section className="mb-8">
        <h2 className="text-2xl sm:text-3xl font-semibold mb-4 text-center">Projects Overview</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
          <div className="bg-white p-4 rounded-lg shadow-lg text-center">
            <h3 className="text-lg sm:text-xl font-bold">Total Projects</h3>
            <p className="text-2xl sm:text-3xl font-bold text-blue-500">10</p>
          </div>
          <div className="bg-white p-4 rounded-lg shadow-lg text-center">
            <h3 className="text-lg sm:text-xl font-bold">Active Projects</h3>
            <p className="text-2xl sm:text-3xl font-bold text-green-500">5</p>
          </div>
          <div className="bg-white p-4 rounded-lg shadow-lg text-center">
            <h3 className="text-lg sm:text-xl font-bold">Weekly Progress</h3>
            <p className="text-2xl sm:text-3xl font-bold text-orange-500">75%</p>
          </div>
        </div>
      </section>
      ...
      <section className="mb-8">
        <h2 className="text-2xl sm:text-3xl font-semibold mb-4 text-center">Analytics</h2>
        <DashboardAnalytics />
      </section>

      {/* Step 4: Recent Activities */}
      <section className="mb-8" ref={recentActivitiesRef}>
        <h2 className="text-2xl sm:text-3xl font-semibold mb-4 text-center">Recent Activities</h2>
        <RecentActivities />
      </section>
    </div>
  );
